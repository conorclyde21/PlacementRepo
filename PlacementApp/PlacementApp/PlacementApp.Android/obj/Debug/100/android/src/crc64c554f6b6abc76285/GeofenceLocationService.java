...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geofence.GeofenceLocationService, Plugin.Geofence", GeofenceLocationService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GeofenceLocationService.class)
			mono.android.TypeManager.Activate ("Plugin.Geofence.GeofenceLocationService, Plugin.Geofence", "", this, new java.lang.Object[] {  });
	}
